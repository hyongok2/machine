...
//            modes["Recipe Auto Change Mode"] = GG.Equip.CtrlSetting.AutoRecipeChange == 1;
        ...
        private void UpdateEquipImage(UcrlEquipView eqpView)
        {
            try
            {
                ...
                eqpView.SetLoadButtonLamp(0, (GG.Equip.Efem.LoadPort1.IsLdButtonWaitStep || GG.Equip.Efem.LoadPort1.IsUnldButtonWaitStep) && DateTime.Now.Millisecond < 600);
                eqpView.SetLoadButtonLamp(1, (GG.Equip.Efem.LoadPort2.IsLdButtonWaitStep || GG.Equip.Efem.LoadPort2.IsUnldButtonWaitStep) && DateTime.Now.Millisecond < 600);
        ...
        private void btndAutoStart_DelayClick(object sender, EventArgs e)
        {
            ...
            {
                GG.Equip.processStatsToolCount = 1;
                GG.Equip.StLoading._firstTry = true;
            }

            GG.ReviewJudgeWait = false;
            GG.Equip.IsTransferToLoad = false;
            GG.Equip.IsTransferFromLoad = false;
        ...
        private void CimStatusChagne(object sender, EventArgs e)
        {
            ...
            else if (str == "Local")
            {
                ...
                Logger.Log.AppendLine(LogLevel.Info, "사용자에 의해 Local로 변경 됨");
            ...
            else if(str == "Remote")
            {
                ...
                Logger.Log.AppendLine(LogLevel.Info, "사용자에 의해 Remote로 변경 됨");
        ...
        {
            AlarmMgr.Instance.Happen(GG.Equip, EM_AL_LST.AL_0472_PMAC_ALIVE_ERROR);
        }
    }
}
