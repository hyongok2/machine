...
namespace EquipMainUi.Struct.Detail
{
    public class PreAlignerOcrCylinder
    {
        ...
        public bool IsUp
        {
            get
            {
                return XB_UpComplete.vBit == true && XB_DownComplete.vBit == false && YB_UpCmd.vBit == true;
            }
        }
        public bool IsDown
        {
            get
            {
                return XB_UpComplete.vBit == false && XB_DownComplete.vBit == true && YB_UpCmd.vBit == false;
            }
        }
    }
}
