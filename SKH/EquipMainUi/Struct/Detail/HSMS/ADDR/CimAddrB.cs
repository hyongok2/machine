...
namespace DitCim.PLC
{
    public class CIMAB
    {
        ...
        public static PlcAddr YB_RESULT_WAFER_COMMAND_REPLY = new PlcAddr(PlcMemType.S, 64, 0, 1, PlcValueType.BIT);
        ...
        public static PlcAddr XB_RESULT_WAFER_COMMAND       = new PlcAddr(PlcMemType.S, 10015, 0, 1, PlcValueType.BIT);
        ...
        public static void Initailize(IVirtualMem plc)
        {
            ...
            YB_RESULT_WAFER_COMMAND_REPLY.PLC =
