...
namespace EquipMainUi.Monitor
{
    ...
    {
        // Loading
        T000_PIO_RECEIVE_WAIT_START,
        T000_PIO_RECEIVE_WAIT_END,
        ...
        T035_WAIT_LD_SIGNAL_START,
        T035_WAIT_LD_SIGNAL_END,
        ...
        T155_INSP_UNLOADING_SIGNAL_COMPLETE_START,
        T155_INSP_UNLOADING_SIGNAL_COMPLETE_END,
    ...
    public class TactTimeMgr
    {
        ...
        {
            //new TactTimeSpan("PIO Receive Wait",		    /**/EM_TT_LST.T000_PIO_RECEIVE_WAIT_START,	            /**/EM_TT_LST.T000_PIO_RECEIVE_WAIT_END),
            new TactTimeSpan("Robot Exchange(IN)",          /**/EM_TT_LST.T010_PIO_RECEIVE_ACTUAL_START ,       /**/EM_TT_LST.T010_PIO_RECEIVE_ACTUAL_END),
            ...
            new TactTimeSpan("Wait Ld Comp Signal",		        /**/EM_TT_LST.T035_WAIT_LD_SIGNAL_START,	        /**/EM_TT_LST.T035_WAIT_LD_SIGNAL_END),
            ...
            new TactTimeSpan("TTTM",                        /**/EM_TT_LST.T055_TTTM_START,                      /**/EM_TT_LST.T055_TTTM_END),
        ...
        {
            if(waferId == null || waferId.Equals(""))
            {
