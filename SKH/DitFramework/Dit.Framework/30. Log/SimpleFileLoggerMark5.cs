...
{
    public class SimpleFileLoggerMark5
    {
        // 상수
        private static readonly int StorageDay = 10;        // 로그의 보관일수
        ...
        // 생성자
        public SimpleFileLoggerMark5(string logPath, string baseFileName, double timerInterval, long fileSizeLimit, ListView logView)
        {
