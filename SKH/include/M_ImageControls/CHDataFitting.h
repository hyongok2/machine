...
public:
	...
	// constructors
	CircleData() { a = 0.; b = 0.; r = 1.; s = 0.; i = 0; j = 0; }
	CircleData(double aa, double bb, double rr) { a = aa; b = bb; r = rr; }
	~CircleData() {}
...
public:
	...
	// Levenber Circle Fitting
	static int CircleFitting_LevenbergMarquardtFull(VectorDouble& vectorX, VectorDouble& vectorY, CircleData* pCircle, double dLambda, CircleData* pOutCircle);
