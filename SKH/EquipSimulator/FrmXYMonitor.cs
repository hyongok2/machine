...
{
    public partial class FrmXYMonitor : Form
    {
        ...
        {
            InitailizeAddress(dgvX000, new X000(), GG.PLC);
        ...
        private void InitailizeAddress(DataGridView dgv, object idb, VirtualMem plc)
        {
            dgv.Tag = plc;
        ...
        private void tmrMonitor_Tick(object sender, EventArgs e)
        {
            ...
            UpdateBitWordValues(dgvInsp);
            UpdateBitWordValues(dgvReveiw);
        }
