    ...
    public static class TransferDataMgr
    {
        ...
        {            
            ...
            if (srcUnit != null
                ...
                && (GG.Equip.EquipRunMode == EmEquipRunMode.Manual 
                ? (srcUnit.LowerWaferKey == null || srcUnit.LowerWaferKey.SlotNo != srcData.Slot)
                : srcUnit.LowerWaferKey != null)
                )
            {
                ...
                try
                {
                    ...
                    Logger.TransferDataLog.AppendLine(LogLevel.NoLog, "WaferMove(Out Update) {0}.{1}_{2}->{3}",
