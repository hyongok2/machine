    ...
    public class EFEMLoadPortStatus
    {
        ...
        public bool MappingCopyTo(ref EFEMLoadPortStatus dest)
        {
            ...
            if (GG.TestMode)
            {
                ...
                dest.MappingData[08] = EmEfemMappingInfo.Absence;
                dest.MappingData[07] = EmEfemMappingInfo.Absence; 
                dest.MappingData[06] = EmEfemMappingInfo.Absence; 
                dest.MappingData[05] = EmEfemMappingInfo.Absence;
                dest.MappingData[04] = EmEfemMappingInfo.Absence; 
                dest.MappingData[03] = EmEfemMappingInfo.Absence;
                dest.MappingData[02] = EmEfemMappingInfo.Absence;
                dest.MappingData[01] = EmEfemMappingInfo.Absence;
                dest.MappingData[01] = EmEfemMappingInfo.Absence;
                dest.MappingData[00] = EmEfemMappingInfo.Absence;
        ...
        {
            EFEMLPMUnit LoadPort = target == EmEfemPort.LOADPORT1 ? GG.Equip.Efem.LoadPort1 : GG.Equip.Efem.LoadPort2;
            ...
            switch (msgs.IndexOf(data))
            {
                ...
                case 2:
                    ...
                    if (LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S110_WAIT_LOAD_BUTTON_PUSH || LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S650_WAIT_UNLD_BUTTON_PUSH || LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S670_WAIT_UNLD_BUTTON_PUSH)
                    {
                        LoadPort.boLoadButtonPush = true;
                        Logger.Log.AppendLine(LogLevel.Info, "{0} EFEM Load 수동 Button Push", target.ToString());
                    }
                    break;
                case 3: IsUnloadButtonPushed = true; break;
