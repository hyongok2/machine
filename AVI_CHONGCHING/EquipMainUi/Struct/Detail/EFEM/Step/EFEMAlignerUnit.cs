                        ...
                        || (equip.BCR1.IsReadComplete == true || equip.BCR2.IsReadComplete == true))
                    {
                            ...
                            )
                        {
                            ...
                            else
                            {
                                if (GG.Equip.IsAutoOnlyAligner)
                                {
                                    ...
                                    Logger.Log.AppendLine(LogLevel.Error, "BCR Read Error (OnlyAlignerMode) 1:{0}, 2{1} (Format:{2})",
                                        equip.BCR1.ReadValue, equip.BCR2.ReadValue, equip.InitSetting.OCR_BCR_Regex);
                                    _bcrReadOk = true;
                                    _seqStepNum = EmEFEMAlignerSeqStep.S400_BCR_ID_CHECK;
                                }
                                else
                                {
                                    ...
                                    Logger.Log.AppendLine(LogLevel.Error, "BCR Read Error 1:{0}, 2{1} (Format:{2})",
                                        equip.BCR1.ReadValue, equip.BCR2.ReadValue, equip.InitSetting.OCR_BCR_Regex);
                        ...
                        else
                        {
                            if (equip.BCR1.IsReadValueError == false)
                                _waferIDFromRead = _readVal1.Substring(0, 10); //"TC5XX-NNNN "
