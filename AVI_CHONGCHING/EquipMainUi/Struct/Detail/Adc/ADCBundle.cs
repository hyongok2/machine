...
namespace EquipMainUi.Struct.Detail.Adc
{
    ...
    public class ADCBundle
    {
        public ADCBundle(
            ...
            ADConverter_AJ65SBT2B_64TD temp2)
        {
            Temperature2 = temp2;
            Temperature = temp;
            Adc1 = adc1;
        ...
        public ADConverter_AJ65SBT2B_64TD Temperature2 { get; set; }
        ...
        public float CurCPBoxTemp2
        {
            get
            {
                float f;
                float.TryParse(Temperature2.ReadDataBuf[0].ToString("N2"), out f);

                return f;
            }
        }
        public float CurPCRackTemp2
        {
            get
            {
                float f;
                float.TryParse(Temperature2.ReadDataBuf[1].ToString("N2"), out f);
        ...
        public void Initialize()
        {
            ...
            this.Temperature2.TDSetting.Load(PcAnalogRegulatorSetting.PATH_SETTING_TD1);
        }

        public void LogicWorking(Equipment equip)
        {
            //Temperature.LogicWorking();
            Temperature2.LogicWorking();
            Adc1.LogicWorking();
        }
    }
}
