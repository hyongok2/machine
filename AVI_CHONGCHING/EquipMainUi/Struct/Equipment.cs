...
namespace EquipMainUi.Struct
{
    ...
    public class Equipment
    {
        ...
        public Sensor SERVO_MC_POWER_ON_1                           /**/ = new Sensor();
        ...
        public SwitchAirKnife AirKnife = new SwitchAirKnife();

        public OHTSignal OHT = new OHTSignal();
        //================================================================================================================
        public ADCBundle ADC = new ADCBundle(
           new AdcTemperature(2),
           new ADConverter_AJ65BTCU_68ADVN(0x2222, 0x2022, 7),
           new ADConverter_AJ65SBT2B_64TD(2)
           );
        #region Aligner
        ...
        public MotorLongRunStep MotorLongRun = new MotorLongRunStep();
        ...
        public bool UseSetDitAlignerRecipe;
        ...
        public ObservableList<TerminalMsgItem> TerminalMsgObserver = new ObservableList<TerminalMsgItem>();
        ...
        public bool Initalize()
        {
            ...
            OCR.SetReadValueRegex(InitSetting.OCR_BCR_Regex);
            BCR1.SetReadValueRegex(InitSetting.OCR_BCR_Regex);
            BCR2.SetReadValueRegex(InitSetting.OCR_BCR_Regex);
        ...
        public void SetAddress()
        {
            ...
            AirKnife.YB_OnOff = AddressMgr.GetAddress("AIR_KNIFE", 0);
            ...
            //ADC.Temperature.SetAddress(9, 0x06, GG.CCLINK);
            ADC.Temperature2.SetAddress(9, 0x0C, GG.CCLINK);
        ...
        public void UpdateKerfData(float[] kerfData)
        {
            ...
            int idx = 0;
            info.KerfData_Right_Col_1 = (double)kerfData[idx++];
            info.KerfData_Right_Row_1 = (double)kerfData[idx++];
            info.KerfData_Right_1 = (double)kerfData[idx++];
            info.KerfData_Right_Col_2 = (double)kerfData[idx++];
            info.KerfData_Right_Row_2 = (double)kerfData[idx++];
            info.KerfData_Right_2 = (double)kerfData[idx++];
            info.KerfData_Right_Col_3 = (double)kerfData[idx++];
            info.KerfData_Right_Row_3 = (double)kerfData[idx++];
            info.KerfData_Right_3 = (double)kerfData[idx++];
            info.KerfData_Right_Col_4 = (double)kerfData[idx++];
            info.KerfData_Right_Row_4 = (double)kerfData[idx++];
            info.KerfData_Right_4 = (double)kerfData[idx++];
            info.KerfData_Right_Col_5 = (double)kerfData[idx++];
            info.KerfData_Right_Row_5 = (double)kerfData[idx++];
            info.KerfData_Right_5 = (double)kerfData[idx++];
            info.KerfData_Right_Col_6 = (double)kerfData[idx++];
            info.KerfData_Right_Row_6 = (double)kerfData[idx++];
            info.KerfData_Right_6 = (double)kerfData[idx++];
            info.KerfData_Right_Col_7 = (double)kerfData[idx++];
            info.KerfData_Right_Row_7 = (double)kerfData[idx++];
            info.KerfData_Right_7 = (double)kerfData[idx++];
            info.KerfData_Right_Col_8 = (double)kerfData[idx++];
            info.KerfData_Right_Row_8 = (double)kerfData[idx++];
            info.KerfData_Right_8 = (double)kerfData[idx++];
            info.KerfData_Right_Col_9 = (double)kerfData[idx++];
            info.KerfData_Right_Row_9 = (double)kerfData[idx++];
            info.KerfData_Right_9 = (double)kerfData[idx++];
            info.KerfData_Right_Col_10 = (double)kerfData[idx++];
            info.KerfData_Right_Row_10 = (double)kerfData[idx++];
            info.KerfData_Right_10 = (double)kerfData[idx++];
            info.KerfData_Right_Col_11 = (double)kerfData[idx++];
            info.KerfData_Right_Row_11 = (double)kerfData[idx++];
            info.KerfData_Right_11 = (double)kerfData[idx++];
            info.KerfData_Right_Col_12 = (double)kerfData[idx++];
            info.KerfData_Right_Row_12 = (double)kerfData[idx++];
            info.KerfData_Right_12 = (double)kerfData[idx++];
            info.KerfData_Right_Col_13 = (double)kerfData[idx++];
            info.KerfData_Right_Row_13 = (double)kerfData[idx++];
            info.KerfData_Right_13 = (double)kerfData[idx++];
            info.KerfData_Right_Col_14 = (double)kerfData[idx++];
            info.KerfData_Right_Row_14 = (double)kerfData[idx++];
            info.KerfData_Right_14 = (double)kerfData[idx++];
            info.KerfData_Right_Col_15 = (double)kerfData[idx++];
            info.KerfData_Right_Row_15 = (double)kerfData[idx++];
            info.KerfData_Right_15 = (double)kerfData[idx++];
            info.KerfData_Right_Col_16 = (double)kerfData[idx++];
            info.KerfData_Right_Row_16 = (double)kerfData[idx++];
            info.KerfData_Right_16 = (double)kerfData[idx++];
            info.KerfData_Right_Col_17 = (double)kerfData[idx++];
            info.KerfData_Right_Row_17 = (double)kerfData[idx++];
            info.KerfData_Right_17 = (double)kerfData[idx++];
            info.KerfData_Right_Col_18 = (double)kerfData[idx++];
            info.KerfData_Right_Row_18 = (double)kerfData[idx++];
            info.KerfData_Right_18 = (double)kerfData[idx++];
            info.KerfData_Right_Col_19 = (double)kerfData[idx++];
            info.KerfData_Right_Row_19 = (double)kerfData[idx++];
            info.KerfData_Right_19 = (double)kerfData[idx++];
            info.KerfData_Right_Col_20 = (double)kerfData[idx++];
            info.KerfData_Right_Row_20 = (double)kerfData[idx++];
            info.KerfData_Right_20 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_1 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_1 = (double)kerfData[idx++];
            info.KerfData_Bottom_1 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_2 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_2 = (double)kerfData[idx++];
            info.KerfData_Bottom_2 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_3 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_3 = (double)kerfData[idx++];
            info.KerfData_Bottom_3 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_4 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_4 = (double)kerfData[idx++];
            info.KerfData_Bottom_4 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_5 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_5 = (double)kerfData[idx++];
            info.KerfData_Bottom_5 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_6 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_6 = (double)kerfData[idx++];
            info.KerfData_Bottom_6 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_7 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_7 = (double)kerfData[idx++];
            info.KerfData_Bottom_7 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_8 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_8 = (double)kerfData[idx++];
            info.KerfData_Bottom_8 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_9 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_9 = (double)kerfData[idx++];
            info.KerfData_Bottom_9 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_10 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_10 = (double)kerfData[idx++];
            info.KerfData_Bottom_10 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_11 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_11 = (double)kerfData[idx++];
            info.KerfData_Bottom_11 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_12 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_12 = (double)kerfData[idx++];
            info.KerfData_Bottom_12 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_13 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_13 = (double)kerfData[idx++];
            info.KerfData_Bottom_13 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_14 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_14 = (double)kerfData[idx++];
            info.KerfData_Bottom_14 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_15 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_15 = (double)kerfData[idx++];
            info.KerfData_Bottom_15 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_16 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_16 = (double)kerfData[idx++];
            info.KerfData_Bottom_16 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_17 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_17 = (double)kerfData[idx++];
            info.KerfData_Bottom_17 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_18 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_18 = (double)kerfData[idx++];
            info.KerfData_Bottom_18 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_19 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_19 = (double)kerfData[idx++];
            info.KerfData_Bottom_19 = (double)kerfData[idx++];
            info.KerfData_Bottom_Col_20 = (double)kerfData[idx++];
            info.KerfData_Bottom_Row_20 = (double)kerfData[idx++];
            info.KerfData_Bottom_20 = (double)kerfData[idx++];
            info.KerfData_01_DIE_COL = (double)kerfData[idx++];
            info.KerfData_01_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_01_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_01_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_01_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_01_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_02_DIE_COL = (double)kerfData[idx++];
            info.KerfData_02_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_02_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_02_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_02_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_02_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_03_DIE_COL = (double)kerfData[idx++];
            info.KerfData_03_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_03_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_03_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_03_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_03_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_04_DIE_COL = (double)kerfData[idx++];
            info.KerfData_04_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_04_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_04_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_04_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_04_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_05_DIE_COL = (double)kerfData[idx++];
            info.KerfData_05_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_05_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_05_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_05_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_05_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_06_DIE_COL = (double)kerfData[idx++];
            info.KerfData_06_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_06_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_06_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_06_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_06_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_07_DIE_COL = (double)kerfData[idx++];
            info.KerfData_07_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_07_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_07_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_07_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_07_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_08_DIE_COL = (double)kerfData[idx++];
            info.KerfData_08_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_08_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_08_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_08_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_08_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_09_DIE_COL = (double)kerfData[idx++];
            info.KerfData_09_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_09_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_09_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_09_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_09_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_10_DIE_COL = (double)kerfData[idx++];
            info.KerfData_10_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_10_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_10_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_10_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_10_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_11_DIE_COL = (double)kerfData[idx++];
            info.KerfData_11_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_11_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_11_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_11_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_11_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_12_DIE_COL = (double)kerfData[idx++];
            info.KerfData_12_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_12_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_12_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_12_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_12_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_13_DIE_COL = (double)kerfData[idx++];
            info.KerfData_13_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_13_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_13_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_13_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_13_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_14_DIE_COL = (double)kerfData[idx++];
            info.KerfData_14_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_14_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_14_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_14_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_14_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_15_DIE_COL = (double)kerfData[idx++];
            info.KerfData_15_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_15_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_15_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_15_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_15_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_16_DIE_COL = (double)kerfData[idx++];
            info.KerfData_16_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_16_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_16_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_16_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_16_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_17_DIE_COL = (double)kerfData[idx++];
            info.KerfData_17_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_17_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_17_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_17_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_17_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_18_DIE_COL = (double)kerfData[idx++];
            info.KerfData_18_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_18_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_18_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_18_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_18_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_19_DIE_COL = (double)kerfData[idx++];
            info.KerfData_19_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_19_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_19_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_19_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_19_WIDTH_LEFT = (double)kerfData[idx++];
            info.KerfData_20_DIE_COL = (double)kerfData[idx++];
            info.KerfData_20_DIE_ROW = (double)kerfData[idx++];
            info.KerfData_20_WIDTH_TOP = (double)kerfData[idx++];
            info.KerfData_20_WIDTH_RIGHT = (double)kerfData[idx++];
            info.KerfData_20_WIDTH_BOTTOM = (double)kerfData[idx++];
            info.KerfData_20_WIDTH_LEFT = (double)kerfData[idx++];

            StringBuilder kerfLogBuilder = new StringBuilder();

            kerfLogBuilder.Append("\n");
            kerfLogBuilder.Append(info.KerfData_Right_Col_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Col_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_Row_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Right_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_1.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_2.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_3.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_4.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_5.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_6.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_7.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_8.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_9.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_10.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_11.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_12.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_13.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_14.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_15.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_16.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_17.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_18.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_19.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Col_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_Row_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_Bottom_20.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_01_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_02_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_03_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_04_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_05_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_06_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_07_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_08_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_09_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_10_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_11_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_12_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_13_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_14_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_15_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_16_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_17_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_18_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_19_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_DIE_COL.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_DIE_ROW.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_WIDTH_TOP.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_WIDTH_RIGHT.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_WIDTH_BOTTOM.ToString()); kerfLogBuilder.Append(", ");
            kerfLogBuilder.Append(info.KerfData_20_WIDTH_LEFT.ToString()); kerfLogBuilder.Append(", ");
            
            bool result = info.Update();

            if (result == true)
            {
                Logger.Log.AppendLine(LogLevel.Info, "kerf Data 업데이트 : {0}", kerfLogBuilder.ToString());
            }
            else
            {
        ...
        public bool CheckCstMapData(EmEfemMappingInfo[] mappingData, string _cstID)
        {
        ...
        public void LogicWorking()
        {
            try
            {
                ...
                if (this.IsIoTestMode == false)
                {
                    ...
                    MotorLongRun.LogicWorking(this);
        ...
        private void WriteToPLC()
        {
            ...
            GG.MEM_DIT.WriteToPLC(GG.HSMS_WRITE_MEM, GG.HSMS_WRITE_MEM.Length); // 2024/10/10 Kerf Data 보고 항목이 추가되어, 20000번 Address를 쓰기 위하여 추가함. 문형옥, 정재엽
        ...
        private DateTime _lastNoneOHTTime;
        private bool EquipStatusCheck()
        {
            ...
            {
                AirKnife.OnOff(GG.Equip, this.StScanning.IsScanningStep);
            }
            ...
            if (GG.TestMode == false)
            {
                ...
                {
                    if (TopDoor01.IsOnOff)
                    {
                        AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0024_TOP_DOOR_01_OPEN);
                        InterLockMgr.AddInterLock("Interlock<Door Open>\n TopDoor01 Open 상태입니다.");
                    }
                    if (TopDoor02.IsOnOff)
                    {
                        AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0025_TOP_DOOR_02_OPEN);
                        InterLockMgr.AddInterLock("Interlock<Door Open>\n TopDoor02 Open 상태입니다.");
                    }
                    if (TopDoor03.IsOnOff)
                    {
                        AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0026_TOP_DOOR_03_OPEN);
                        InterLockMgr.AddInterLock("Interlock<Door Open>\n TopDoor03 Open 상태입니다.");
                    }
                    if (TopDoor04.IsOnOff)
                    {
                        AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0027_TOP_DOOR_04_OPEN);
                        InterLockMgr.AddInterLock("Interlock<Door Open>\n TopDoor04 Open 상태입니다.");
                    }
                }
                ...
                if (this.Efem.LoadPort1.LoadType == EmLoadType.Manual && this.Efem.LoadPort2.LoadType == EmLoadType.Manual)
                {
                    ...
                    _lastNoneOHTTime = PcDateTime.Now;
                }
                else if (this.Efem.LoadPort1.LoadType == EmLoadType.OHT || this.Efem.LoadPort2.LoadType == EmLoadType.OHT)
                {
                    ...
                    if ((PcDateTime.Now - _lastNoneOHTTime).TotalMilliseconds > 1000)
                    {
                        if (EfemDoor01.IsOnOff == false && this.EquipRunMode == EmEquipRunMode.Auto) AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0029_EFEM_DOOR_01_OPEN);
                        if (EfemDoor02.IsOnOff == false && this.EquipRunMode == EmEquipRunMode.Auto) AlarmMgr.Instance.Happen(this, EM_AL_LST.AL_0030_EFEM_DOOR_02_OPEN);
                    }
        ...
        private void ButtonCheck()
        {
            ...
            if (GG.TestMode == false && GG.EfemNoUse == false && GG.Equip.Efem.Status.IsDoorClose == false)
            {
        ...
        public string GetLpmProgress(int portNo)
        {
            ...
            else if (LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S685_DEEP_LEARNING_REVIEW_WAIT)
            {
                return string.Format(GG.boChinaLanguage ? "(深度学习 Review) 待机中" : "딥 러닝 리뷰 대기");
            }
                ...
                || LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S710_OHT_ULD_COMMUNICATION_START
                || LoadPort.SeqStepNum == EmEFEMLPMSeqStep.S720_OHT_ULD_COMPLETE_WAIT))
