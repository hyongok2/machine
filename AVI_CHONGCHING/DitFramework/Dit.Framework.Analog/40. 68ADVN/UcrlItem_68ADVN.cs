...
{
    public partial class UcrlItem_68ADVN : UserControl
    {
        private ADConverter_AJ65BTCU_68ADVN _advn = null;
        private List<UcrlIoItem> _lstIoViewItems = new List<UcrlIoItem>();

        public UcrlItem_68ADVN()
        {
            InitializeComponent();
        ...
        public void FillMonitor(int index = 1)
        {
            for (int iPos = 0; iPos < 8; iPos++)
            {
                ...
                {
                    SetView(iPos, string.Format("AD{0}_CH{1}_CONVERSION_COMPLETE", index, iPos + 1),            /**/_advn.XB_A2DCompleteFlag[iPos]);
                }
                else
                {
                    SetView(iPos, "",                                                                           /**/null);
            ...
            SetView(08, "",                                                                                     /**/null);
            SetView(09, "",                                                                                     /**/null);
            SetView(10, string.Format("AD{0}_INITIAL_DATA_PROCESSING_REQUEST", index),                          /**/_advn.XB_DataInitReqFlag);
            SetView(11, string.Format("AD{0}_INITIAL_DATA_SETTING_COMPLETE_FLAG", index),                       /**/_advn.XB_DataSetCompleteFlag);
            SetView(12, string.Format("AD{0}_ERROR_STATE_FLAG", index),                                         /**/_advn.XB_ErrorStatusFlag);
            SetView(13, string.Format("AD{0}_REMOTE_READY", index),                                                   /**/_advn.XB_RemoteReady);
            SetView(14, "",                                                                                     /**/null);
            SetView(15, "",                                                                                     /**/null);
            SetView(16, "",                                                                                     /**/null);
            SetView(17, "",                                                                                     /**/null);
            ...
            SetView(32, "",                                                                                     /**/null);
            SetView(33, "",                                                                                     /**/null);
            SetView(34, string.Format("AD{0}_NITIAL_DATA_PROCESS_COMPLETE_FLAG", index),                        /**/_advn.YB_DataInitCompleteFlag);
            SetView(35, string.Format("AD{0}_NITIAL_DATA_SETTING_REQUEST_FLAG", index),                         /**/_advn.YB_DataSetReqFlag);
            SetView(36, string.Format("AD{0}_RROR_RESET_FLAG", index),                                          /**/_advn.YB_ErrorResetFlag);
            SetView(37, "",                                                                                     /**/null);
            SetView(38, "",                                                                                     /**/null);
            SetView(39, "",                                                                                     /**/null);
            SetView(40, "",                                                                                     /**/null);
