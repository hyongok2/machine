...
namespace Dit.FrameworkSingle.Net.DNet
{
    ...
    {
        private readonly int id = 0;
        public DNetPacket RecvPacket
        {
            get;
            set;
        }
        public DNetReceiveEventArgs(int id, DNetPacket packet )
        {
            this.id = id;
    ...
    {   
        public DNetAcceptEventArgs(DNetServerSession conn)
        {
            this.Worker = conn;
        }
        public DNetServerSession Worker
        {
            get;
            set;
        }
